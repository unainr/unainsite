...
const features: Feature[] = [
	...
	},
	{
		...
		icon: (
			<MonitorSmartphone className="w-10 h-10 dark:text-white text-white" />
		),
	},
];
			...
			<div className="max-w-7xl mx-auto">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
						I design and develop high-performance web experiences powered by
						modern frameworks, intelligent AI systems, and refined UI design
						...
						return (
							<div key={index} className="relative h-80">
								...
								<div className="relative z-10 p-8 rounded-3xl h-full flex flex-col bg-black/80 border border-white/20 dark:border-white/10">
									...
									<p className="leading-relaxed grow text-gray-100 font-medium">
										{feature.description}
									</p>
